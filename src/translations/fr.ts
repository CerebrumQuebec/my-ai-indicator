export const fr = {
  ...
  monthlyDonation: "Mensuel",
  amount: "Montant",
  customAmount: "Autre montant (minimum 1$)",
  loading: "Chargement...",
  subscribe: "S'abonner",
  perMonth: "/mois",
  donationSuccessTitle: "Merci pour votre don !",
  donationSuccessMessage:
    "Votre soutien nous aide à poursuivre notre mission. Nous apprécions sincèrement votre générosité.",
  ...
  // Introduction
  welcomeTitle: "Bienvenue sur Badge IA",
  welcomeDescription:
    "Cet outil vous aidera à déterminer dans quelle mesure votre processus créatif utilise l'intelligence artificielle. Inspiré du modèle Creative Commons, notre badge offre une transparence sur la genèse de votre œuvre.",
  licenseQuestion: "Savez-vous quel type de licence vous avez besoin ?",
  yes: "Oui",
  no: "Non",
  ...
  faqDescription:
    "Trouvez des réponses aux questions courantes sur le Badge IA.",

  // FAQ Questions
  faqQuestion1: "Qu'est-ce que le Badge IA ?",
  faqAnswer1:
    "Le Badge IA est un outil qui aide les créateurs à communiquer de manière transparente le niveau d'implication de l'IA dans leurs œuvres créatives, similaire à la façon dont les licences Creative Commons communiquent les droits d'utilisation.",

  faqQuestion2:
    "Pourquoi devrais-je indiquer l'utilisation de l'IA dans mon travail ?",
  faqAnswer2:
    "Indiquer l'utilisation de l'IA établit la confiance avec votre public, aide à définir des attentes appropriées et contribue à la transparence à une époque où le contenu généré par l'IA devient plus courant.",

  faqQuestion3:
    "Comment déterminer dans quelle catégorie se trouve mon travail ?",
  faqAnswer3:
    "Vous pouvez soit sélectionner directement une catégorie si vous connaissez votre niveau d'utilisation de l'IA, soit utiliser notre questionnaire qui vous guidera à travers une série de questions pour déterminer la catégorie appropriée.",

  faqQuestion4:
    "Puis-je utiliser différentes catégories pour différentes parties de mon travail ?",
  faqAnswer4:
    "Oui, vous pouvez indiquer différents niveaux d'utilisation de l'IA pour différents aspects de votre travail, comme des badges distincts pour la musique et les paroles d'une chanson.",

  faqQuestion5: "Est-ce une obligation légale ?",
  faqAnswer5:
    "Non, l'utilisation du Badge IA est volontaire. Cependant, la transparence concernant l'utilisation de l'IA devient de plus en plus importante et pourrait être requise dans certains contextes à l'avenir.",

  // About Page
  aboutTitle: "À propos du Badge IA",
  aboutIntroTitle: "Introduction",
  aboutIntroText:
    "Le Badge IA est un système standardisé conçu pour communiquer de manière transparente le niveau d'implication de l'IA dans les œuvres créatives. Inspiré par Creative Commons, il fournit un cadre clair permettant aux créateurs d'indiquer comment l'IA a été utilisée dans leur processus de création.",
  aboutMissionTitle: "Notre Mission",
  aboutMissionText:
    "Notre mission est de promouvoir la transparence dans la création assistée par l'IA en fournissant un moyen simple et standardisé pour les créateurs de communiquer le niveau d'implication de l'IA dans leur travail. Nous croyons que la transparence établit la confiance et aide le public à mieux comprendre et apprécier les œuvres créatives à l'ère de l'IA.",
  aboutCategoriesTitle: "Nos Catégories",
  aboutCategoriesText:
  ...
  versionHistoryDescription: "Suivez l'évolution de Badge AI avec des notes de version détaillées et les mises à jour des fonctionnalités.",
  versionHistory: "Historique des Versions",
  currentVersion: "Version Actuelle",
  currentVersionDescription: "La dernière version stable avec toutes les améliorations et fonctionnalités récentes.",
  keyFeatures: "Fonctionnalités Clés :",
  versionHistoryNote: "Vous voulez rester informé ? Les nouvelles versions sont annoncées avec des journaux de modifications détaillés montrant exactement ce qui est nouveau et amélioré.",
